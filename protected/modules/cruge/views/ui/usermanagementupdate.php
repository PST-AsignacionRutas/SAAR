...
<h1><?php echo ucwords(CrugeTranslator::t(	
	$boolIsUserManagement ? "Modificar usuario" : "editando tu perfil"
));?></h1>
<div class="form">
...
<div class="row buttons">
	...
	<?php $this->widget('bootstrap.widgets.TbButton', array('buttonType'=>'submit', 'type'=>'primary', 'label'=>"Modificar Usuario")); ?>
